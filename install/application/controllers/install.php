		...
		*/
		...
		else
		{
			...
			{	
				...
				write_file($_SERVER['DOCUMENT_ROOT'].$subfolder.'blowiitecom/config/blowiitecom.php', $file_contents);
				...
				write_file($_SERVER['DOCUMENT_ROOT'].$subfolder.'blowiitecom/config/config.php', $file_contents);
