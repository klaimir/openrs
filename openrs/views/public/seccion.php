											...
											<?php foreach ($articulos as $art): ?>
												<div class="articulo-blog img-galeria <?php echo ($primero == TRUE) ? '' : 'borde-articulo';?> <?php echo ($contador>='4'  || $contador >= $maximo)?' oculto':'';?> <?php echo 'pagina-'.$num_pagina; ?>">
														...
														<?php if ($art->img_articulo != ''): ?>
															<div>
																<img src="<?php echo base_url('uploads/general/img/blog/'.$art->id_autor.'/'.$art->id_idioma.'/'.$art->img_articulo);?>" class="img-responsive" alt="<?php echo $art->titulo; ?>" title="<?php echo $art->titulo; ?>"/>
															</div>
															<p></p>
														<?php endif; ?>
