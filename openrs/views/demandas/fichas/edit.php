<?php menu_demandas ($demanda->id,"demandas_fichas"); ?>
...
<div class="form-group">            
	...
	$config_mini['filebrowserImageBrowseUrl'] = base_url()."assets/admin/ckeditor/kcfinder/browse.php?type=demandas";
	$config_mini['filebrowserUploadUrl'] = base_url()."assets/admin/ckeditor/kcfinder/upload.php?type=demandas";
