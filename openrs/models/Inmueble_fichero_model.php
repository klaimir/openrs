...
class Inmueble_fichero_model extends MY_Model
{
    ...
    public function __construct()
    {
        ...
        $this->table = 'inmuebles_ficheros';
        $this->view = 'v_inmuebles_ficheros';
        $this->primary_key = 'id';
    ...
    {
        $this->form_validation->set_rules('texto_fichero', 'Nombre del fichero', 'required|is_unique_global_foreign_key[inmuebles_ficheros;' . $id . ';texto_fichero;id;inmueble_id;' . $this->inmueble_id . ']|max_length[200]|xss_clean');
    ...
    public function set_datas_html($datos = NULL)
    {
        ...
        $data['tipos_ficheros'] = $this->Tipo_fichero_model->get_tipos_ficheros_dropdown(2);
    ...
    {
        $datas['fichero'] = 'uploads/inmuebles/'.$this->inmueble_id.'/adjuntos/'.$upload_data['file_name'];
    ...
    function create()
    {
        $config['upload_path'] = './uploads/inmuebles/'.$this->inmueble_id.'/adjuntos';
    ...
    /**
     * Devuelve los ficheros adjuntos de un determinado inmueble
     *
     * @param [inmueble_id]                  Indentificador del elemento
     *
     * @return void
     */
    function get_ficheros_inmueble($inmueble_id)
    {
     ...
     *
     * @param [fichero_inmueble]        Datos del fichero en la base de datos
     *
     * @return void
     */
