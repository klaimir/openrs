...
class Opcion_extra_model extends MY_Model
{
    ...
    public function set_rules($id=0)
    {
        ...
        {            
            $this->form_validation->set_rules('nombre_'.$idioma->id_idioma, 'Nombre en '.$idioma->nombre, 'required|max_length[100]|xss_clean|is_unique_global_foreign_key[opciones_extras_idiomas;' . $id . ';nombre;opcion_extra_id;idioma_id;' . $idioma->id_idioma . ']');
        }        
