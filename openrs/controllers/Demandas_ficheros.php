...
class Demandas_ficheros extends CRUD_controller
{
    ...
    {        
        $this->data['inmueble'] = $this->Demanda_model->get_by_id($inmueble_id);
        // Permisos acceso
        $this->Demanda_model->check_access($this->data['inmueble']);            
    ...
    public function delete($id)
    {
        ...
        $this->data['inmueble'] = $this->Demanda_model->get_by_id($this->data['element']->inmueble_id);
        // Permisos acceso
        $this->Demanda_model->check_access($this->data['inmueble']);
