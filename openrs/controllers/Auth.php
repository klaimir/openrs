...
class Auth extends MY_Controller
{
    ...
    function _render_page($view, $data = null, $render = false)
    {
        ...
        // Show public template for these views
        if ($view === 'auth/login' || $view === 'auth/forgot_password' || $view === 'auth/reset_password')
        {
            $this->render_public($view, $this->viewdata);
        }
        else
        {
            $this->render_private($view, $this->viewdata);
        }
    }
