...
class Plantillas_documentacion extends MY_Controller
{
    ...
    function drop_down()
    {
        ...
        $expected_values=array(
            1 => (string) 'Ficha del Inmueble',
            2 => (string) 'Ficha del Cliente',
            3 => (string) 'Cartel Publicitario',
            4 => (string) 'Ficha visita');
        
        foreach ($expected_values as $key => $value)
        {
            $this->unit->run($value, $plantillas[$key], 'Test de validación '.$key.'-'.$value);
        }      
